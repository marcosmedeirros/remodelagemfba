...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .table-dark { --bs-table-bg: var(--panel-2); --bs-table-border-color: var(--border); }
        ...
        .btn-orange { background: var(--red); border-color: var(--red); color: #fff; }
        .btn-orange:hover { filter: brightness(1.1); color: #fff; }
        .btn-outline-orange { border-color: var(--red); color: var(--red); }
