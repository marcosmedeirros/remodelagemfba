    ...
    <style>
        ...
        body {
            background:
                ...
                radial-gradient(900px 360px at -10% 20%, rgba(255,255,255,.03), transparent 62%),
                var(--fa-bg);
            color: var(--fa-text);
        ...
        .fa-request-card,
        .fa-history-card {
            background: linear-gradient(160deg, rgba(23,28,39,.9), rgba(17,21,29,.92));
            border: 1px solid var(--fa-border);
            border-radius: 12px;
        ...
        .fa-history-player-wrap {
            ...
            padding: .85rem 1rem;
            border-bottom: 1px solid var(--fa-border);
            background: linear-gradient(120deg, rgba(252,0,37,.08), rgba(255,255,255,.03));
        }
        ...
        .fa-request-body { padding: .85rem 1rem .75rem; }
        ...
        .fa-history-row:first-of-type { border-top: none; }
        ...
        @media (max-width: 860px) {
            ...
            .fa-request-grid,
            .fa-history-grid { grid-template-columns: 1fr; }
            .fa-request-actions { flex-direction: column; }
            .fa-request-actions .btn { width: 100%; }
            .fa-history-row { flex-direction: column; align-items: flex-start; }
            .fa-history-value { text-align: left; }
        }
    </style>
</head>
